...
public class Operaciones {
    ...
    private HashMap listarTareas2(String nombreLista) throws IOException {
        ...
        FileReader f = new FileReader("src/AppListaTareas/ficheros/"+nombreLista);
        BufferedReader b = new BufferedReader(f);
    ...
    private String rutaListaElegida(String opcion){
        File file = new File("src/AppListaTareas/ficheros/");

        String listas[] = file.list();

        // Lista cada elemento que hay en el directorio "ficheros" y los vincula con un número
        ...
        archivoElegido = "src/AppListaTareas/ficheros/" + listadoEnumerado.get(opcionElegida);
...
File file = new File("src/AppListaTareas/ficheros/"+nombreLista+".txt");
